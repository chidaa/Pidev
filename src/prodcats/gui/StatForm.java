...
public Form createPieChartForm() {
    ...
    PieChart chart = new PieChart(buildCategoryDataset("Nombre des livreurs selon disponibilité ", values), renderer);
    ...
    Form f = new Form();
    f.add(new SpanLabel("Nombre des livreurs selon disponibilité"));
